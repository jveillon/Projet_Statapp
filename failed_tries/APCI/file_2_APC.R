...
library("writexl")
write_xlsx(deviance_globale,"Deviance_test.xlsx")
...
print(age_effect)
write_xlsx(age_effect,"age_effect.xlsx")
...
print(period_effect)
write_xlsx(period_effect,"period_effect.xlsx")
...
write_xlsx(cohort_average,"cohort_effect.xlsx")
